...
export function createCollection(collectionName, collectionDescription, userId){
    const payload ={
...
export function addImageToCollection(collectionId, collectionName, collectionDescription, imageUrl, userId){
    const payload ={
        collectionName: collectionName,
        collectionDescription:collectionDescription,
