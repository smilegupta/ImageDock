...
import AutogeneratedPage from './Components/Screens/AutoGenerated/AutogeneratedPage'
          ...
          <main className="py-3">
            <Container>
              <Switch>
                ...
                />
                <Route path="/showcase/:userId/:collectionId/:name" component={AutogeneratedPage} exact />
